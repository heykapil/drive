...
export interface ClientOptions {
     ...
     */
    auth?: gateway.AuthParams | AuthDataGenerator
}
...
export type AuthDataGenerator = () =>
    | gateway.AuthParams
    | Promise<gateway.AuthParams | undefined>
    | undefined;
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (!BROWSER) {
            this.headers["User-Agent"] = "api-hszi-Generated-TS-Client (Encore/v1.53.0)";
        }
    ...
    async getAuthData(): Promise<CallParameters | undefined> {
        let authData: gateway.AuthParams | undefined;
